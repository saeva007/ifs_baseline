...
WATCH_JOB="$(sbatch --parsable \
  --export="ALL,RUN_TAG=${RUN_TAG},EVAL_ROOT=${EVAL_ROOT},BASELINE_DIR=${BASELINE_DIR},WATCH_AUTO_RETRY=1,WATCH_ADOPT_MISSING=1,WATCH_ADOPT_DISPATCHER_FAILURE=${WATCH_ADOPT_DISPATCHER_FAILURE},WATCH_POLL_SECONDS=${WATCH_POLL_SECONDS:-180},WATCH_STARTUP_STALE_MINUTES=${WATCH_STARTUP_STALE_MINUTES:-45},WATCH_DATA_STALE_MINUTES=${WATCH_DATA_STALE_MINUTES:-60},WATCH_TRAIN_STALE_MINUTES=${WATCH_TRAIN_STALE_MINUTES:-45},WATCH_VALIDATION_STALE_MINUTES=${WATCH_VALIDATION_STALE_MINUTES:-120},WATCH_CONFIRMATIONS=${WATCH_CONFIRMATIONS:-2},WATCH_RECHECK_SECONDS=${WATCH_RECHECK_SECONDS:-20},WATCH_MAX_RETRIES=${WATCH_MAX_RETRIES:-2},WATCH_EXCLUDE_FAILED_NODES=${WATCH_EXCLUDE_FAILED_NODES:-1}" \
