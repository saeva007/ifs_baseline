...
EXPORTS="ALL,RUN_TAG=${RUN_TAG},DATA_RUN_TAG=${DATA_RUN_TAG},PANGU_DATA_DIR=${PANGU_DATA_DIR},TIANJI_DATA_DIR=${TIANJI_DATA_DIR},ERA5_DATA_DIR=${ERA5_DATA_DIR},OBS_ROOT=${OBS_ROOT},PAPER_EVAL_DIR=${PAPER_EVAL_DIR},OUT_DIR=${OUT_DIR},FEATURES=${FEATURES},FIT_MAX_ROWS=${FIT_MAX_ROWS},TEST_MAX_ROWS=${TEST_MAX_ROWS},SELECTION_SEED=${SELECTION_SEED},LOW_VIS_THRESHOLD_M=${LOW_VIS_THRESHOLD_M},ANALYSIS_SCRIPT=${ANALYSIS_SCRIPT}"
